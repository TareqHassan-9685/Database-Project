 ...
 */
public class Staff_Part extends javax.swing.JFrame {

    /**
     * Creates new form Staff_Part
     */
    public Staff_Part() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Staff_Part.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Staff_Part().setVisible(true);
            }
        });
    }
